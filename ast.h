...
static ParNodeStruct node_struct[] = {
	...
	[AST_ExtDef_is_StructSpecifier_SEMI] = {2, ExtDef, "AST_ExtDef_is_StructSpecifier_SEMI", "ExtDef"},
	[AST_ExtDef_is_StructSpecifier_error] = {2, ExtDef, "AST_ExtDef_is_StructSpecifier_error", "ExtDef"},
	...
	[AST_Specifier_is_TYPE_MULT] = {2, Specifier, "AST_Specifier_is_TYPE_MULT", "Specifier"},
	[AST_Specifier_is_StructSpecifier] = {1, Specifier, "AST_Specifier_is_StructSpecifier", "Specifier"},
	[AST_StructSpecifier_is_STRUCT_Tag] = {2, StructSpecifier, "AST_StructSpecifier_is_STRUCT_Tag", "StructSpecifier"},
	[AST_StructSpecifier_is_STRUCT_OptTag_LC_DefList_RC] = {5, StructSpecifier, "AST_StructSpecifier_is_STRUCT_OptTag_LC_DefList_RC", "StructSpecifier"},
	[AST_Tag_is_ID] = {1, Tag, "AST_Tag_is_ID", "Tag"},
	[AST_OptTag_is_ID] = {1, OptTag, "AST_OptTag_is_ID", "OptTag"},
