...
enum {
	...
	AST_Stmt_is_IF_LP_Exp_RP_Stmt_ElsePart,
	AST_Stmt_is_IF_LP_Exp_RP_LC_StmtList_RC_ElsePart,
	AST_Stmt_is_error_SEMI,
	AST_ElsePart_is_None,
	AST_ElsePart_is_ELSE_Stmt,
	AST_ElsePart_is_ELSE_LC_StmtList_RC,
...
static ParNodeStruct parnodestruct[] = {
	...
	[AST_Stmt_is_IF_LP_Exp_RP_Stmt_ElsePart] = {6, "AST_Stmt_is_IF_LP_Exp_RP_Stmt_ElsePart", "Stmt"},
	[AST_Stmt_is_IF_LP_Exp_RP_LC_StmtList_RC_ElsePart] = {8, "AST_Stmt_is_IF_LP_Exp_RP_LC_StmtList_RC_ElsePart", "Stmt"},
	[AST_Stmt_is_error_SEMI] = {2, "AST_Stmt_is_error_SEMI", "Stmt"},
	[AST_ElsePart_is_None] = {0, "AST_ElsePart_is_None", "ElsePart"},
	[AST_ElsePart_is_ELSE_Stmt] = {2, "AST_ElsePart_is_ELSE_Stmt", "ElsePart"},
	[AST_ElsePart_is_ELSE_LC_StmtList_RC] = {4, "AST_ElsePart_is_ELSE_LC_StmtList_RC", "ElsePart"},
